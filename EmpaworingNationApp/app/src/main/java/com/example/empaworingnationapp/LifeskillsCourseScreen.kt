...
class LifeskillsCourseScreen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lifeskills_screen)
...
// Set an OnClickListener for the Back button
        ...
        val imageView_Firstaid: ImageView = findViewById(R.id.imageView_Firstaid)

        // Set an OnClickListener to navigate to the SixMonthsScreen activity
        imageView_Firstaid.setOnClickListener {
            // Create an Intent to start the SixMonthsScreen activity
