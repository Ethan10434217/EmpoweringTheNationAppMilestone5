...
class LandscapingCourseScreen : AppCompatActivity() {
...
// Set an OnClickListener for the Back button
        ...
        // Find the ImageView by its ID
        val imageView_Sewing: ImageView = findViewById(R.id.imageView_Sewing)

        // Set an OnClickListener to navigate to the SixWeeksScreen activity
        imageView_Sewing.setOnClickListener {
        ...
        // Set an OnClickListener to navigate to the SixMonthsScreen activity
        imageView_Lifeskills.setOnClickListener {
            // Create an Intent to start the SixMonthsScreen activity
